 ...
 *      DEFINES
 *********************/
#define MY_CLASS    &lv_game_2048_class

#define LV_GAME_2048_BG_COLOR             lv_color_hex(0xb3a397)
#define LV_GAME_2048_TEXT_BLACK_COLOR     lv_color_hex(0x6c635b)
#define LV_GAME_2048_TEXT_WHITE_COLOR     lv_color_hex(0xf8f5f0)

#define LV_GAME_2048_NUMBER_EMPTY_COLOR   lv_color_hex(0xc7b9ac)
#define LV_GAME_2048_NUMBER_2_COLOR 		lv_color_hex(0xeee4da)
#define LV_GAME_2048_NUMBER_4_COLOR 		lv_color_hex(0xede0c8)
#define LV_GAME_2048_NUMBER_8_COLOR 		lv_color_hex(0xf2b179)
#define LV_GAME_2048_NUMBER_16_COLOR 		lv_color_hex(0xf59563)
#define LV_GAME_2048_NUMBER_32_COLOR 		lv_color_hex(0xf67c5f)
#define LV_GAME_2048_NUMBER_64_COLOR 		lv_color_hex(0xf75f3b)
#define LV_GAME_2048_NUMBER_128_COLOR 	lv_color_hex(0xedcf72)
#define LV_GAME_2048_NUMBER_256_COLOR 	lv_color_hex(0xedcc61)
#define LV_GAME_2048_NUMBER_512_COLOR 	lv_color_hex(0xedc850)
#define LV_GAME_2048_NUMBER_1024_COLOR 	lv_color_hex(0xedc53f)
#define LV_GAME_2048_NUMBER_2048_COLOR 	lv_color_hex(0xedc22e)
 ...
 *  STATIC PROTOTYPES
 **********************/
static void lv_game_2048_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj);
static void lv_game_2048_destructor(const lv_obj_class_t * class_p, lv_obj_t * obj);
static void lv_game_2048_event(const lv_obj_class_t * class_p, lv_event_t * e);
...
static void update_btnm_map(char * lv_game_2048_btnm_map[], uint16_t matrix[MATRIX_SIZE][MATRIX_SIZE]);
 ...
 *  STATIC VARIABLES
 **********************/
const lv_obj_class_t lv_game_2048_class = {
    .constructor_cb = lv_game_2048_constructor,
    .destructor_cb  = lv_game_2048_destructor,
    .event_cb       = lv_game_2048_event,
    .width_def      = LV_DPI_DEF * 2,
    .height_def     = LV_DPI_DEF * 2,
    .group_def = LV_OBJ_CLASS_GROUP_DEF_TRUE,
    .instance_size  = sizeof(lv_game_2048_t),
...
void lv_game_2048_set_new_game(lv_obj_t * obj)
{
    ...
    lv_game_2048_t * game_2048 = (lv_game_2048_t *)obj;
...
static void btnm_event_cb(lv_event_t * e)
{
    ...
    lv_obj_t * parent = lv_obj_get_parent(btnm);
     ...
     lv_game_2048_t * game_2048 = (lv_game_2048_t *)parent;
    ...
    if(code == LV_EVENT_DRAW_PART_BEGIN) {
        ...
        if((dsc->id >= 0) && (dsc->label_dsc))
        {
            ...
            if (num < 8)
                dsc->label_dsc->color = LV_GAME_2048_TEXT_BLACK_COLOR;
            else
                dsc->label_dsc->color = LV_GAME_2048_TEXT_WHITE_COLOR;
        ...
        else if((dsc->id == 0) && !(dsc->label_dsc))
        {
            ...
            dsc->rect_dsc->bg_color = LV_GAME_2048_BG_COLOR;
...
static lv_color_t get_num_color(uint16_t num)
{
    ...
    switch (num)
    {
        case 0:		color = LV_GAME_2048_NUMBER_EMPTY_COLOR;  break;
        case 1:		color = LV_GAME_2048_NUMBER_EMPTY_COLOR;  break;
        case 2:		color = LV_GAME_2048_NUMBER_2_COLOR;	    break;
        case 4:		color = LV_GAME_2048_NUMBER_4_COLOR;	    break;
        case 8:		color = LV_GAME_2048_NUMBER_8_COLOR;	    break;
        case 16:	color = LV_GAME_2048_NUMBER_16_COLOR;	    break;
        case 32:	color = LV_GAME_2048_NUMBER_32_COLOR;	    break;
        case 64:	color = LV_GAME_2048_NUMBER_64_COLOR;	    break;
        case 128:	color = LV_GAME_2048_NUMBER_128_COLOR;	break;
        case 256:	color = LV_GAME_2048_NUMBER_256_COLOR;	break;
        case 512:	color = LV_GAME_2048_NUMBER_512_COLOR;	break;
        case 1024:	color = LV_GAME_2048_NUMBER_1024_COLOR;   break;
        case 2048:	color = LV_GAME_2048_NUMBER_2048_COLOR;   break;
        default:	color = LV_GAME_2048_NUMBER_2048_COLOR;break;
    }
    return color;
}
...
static void game_2048_event_cb(lv_event_t * e)
{
    ...
    if(code == LV_EVENT_VALUE_CHANGED) {
        if (lv_game_2048_get_best_tile(obj_2048) >= 2048)
            lv_label_set_text(label, "#00b329 YOU WIN! #");
        else if(lv_game_2048_get_status(obj_2048))
            lv_label_set_text(label, "#ff0000 GAME OVER! #");
        else
            lv_label_set_text_fmt(label, "SCORE: #ff00ff %d #", lv_game_2048_get_score(obj_2048));
    }
}
...
static void new_game_btn_event_handler(lv_event_t * e)
{
    ...
    lv_game_2048_set_new_game(obj_2048);
}


void lv_game_2048_simple_test(void)
{
    /*Create 2048 game*/
    lv_obj_t * obj_2048 = lv_game_2048_create(lv_scr_act());
    lv_obj_set_scrollbar_mode(lv_scr_act(), LV_SCROLLBAR_MODE_OFF);
    #if LV_FONT_MONTSERRAT_40
        lv_obj_set_style_text_font(obj_2048, &lv_font_montserrat_40, 0);
    #endif
    lv_obj_set_size(obj_2048, 230, 230);
    //lv_obj_center(obj_2048);
    lv_obj_align_to(obj_2048, lv_scr_act(),LV_ALIGN_CENTER, 0, 25);

    /*Information*/
    lv_obj_t * label = lv_label_create(lv_scr_act());
    lv_label_set_text_fmt(label, "SCORE:%d", lv_game_2048_get_score(obj_2048));
    lv_label_set_recolor(label, true);
    lv_obj_align_to(label, obj_2048, LV_ALIGN_OUT_TOP_RIGHT, -36, -16);
